    ...
    <div className="relative w-full max-w-lg mx-auto">
      <div className="flex items-center">
        <input
          ...
          className="w-full pl-10 pr-12 lg:pr-24 py-3 rounded-2xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent bg-white/80 backdrop-blur-sm transition-all duration-200 px-4 focus:bg-white  text-gray-700 placeholder-gray-500"
        />
