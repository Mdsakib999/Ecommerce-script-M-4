            ...
            <div className="w-full lg:w-1/2 p-8 lg:pl-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <button
                  ...
                  className="w-full bg-gradient-to-r from-blue-600 to-purple-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold py-4 px-6 rounded-md flex items-center justify-center space-x-3 transition-all duration-300 transform shadow-lg hover:shadow-xl"
                >
    ...
    {activeTab === 'specifications' && (
      <div className="space-y-6">
        ...
        <div className="bg-gray-50 rounded-2xl p-6">
          <h4 className="font-semibold text-gray-900 mb-4 text-lg">Product Details</h4>
        ...
        <div className="bg-gray-50 rounded-2xl p-6">
          <h4 className="font-semibold text-gray-900 mb-4 text-lg">Technical Specifications</h4>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {parseSpecifications(product.specifications).map((spec, index) => (
              <div key={index} className="flex justify-between py-3 border-b border-gray-200">
                ...
                <span className="text-gray-900 font-semibold text-right max-w-[200px]">{spec.value}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="bg-gray-50 rounded-2xl p-6">
          <h4 className="font-semibold text-gray-900 mb-4 text-lg">Additional Information</h4>
          <div className="space-y-3">
            ...
            <div className="flex items-center py-2">
              <div className="w-2 h-2 bg-primary rounded-full mr-3"></div>
              <span className="text-gray-700">Authentic product with warranty</span>
            </div>
            <div className="flex items-center py-2">
              <div className="w-2 h-2 bg-primary rounded-full mr-3"></div>
              <span className="text-gray-700">Customer support available 24/7</span>
            </div>
          </div>
        </div>
      </div>
