      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200/50 p-8 mb-8">
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Button
              onSmash={handleTrack}
              className="bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white font-semibold px-8 py-4 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:transform-none min-w-[140px]"
              disabled={isFetching}
            >
              {isFetching ? (
        ...
        {notFound && (
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-red-200 p-8 text-center">
            ...
            <h3 className="text-xl font-semibold text-red-600 mb-2">Order Not Found</h3>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200/50 p-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-8 text-center">
                Order <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Progress</span>
              </h2>
              ...
              <div className="relative">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between relative">
                  {getOrderSteps(order.status).map((step, index, arr) => {
                    ...
                    return (
                      <div key={step.name} className="flex-1 flex flex-col md:flex-row items-center mb-8 md:mb-0">
                        {/* Step Circle */}
                          ...
                          <div
                            className={`w-16 h-16 rounded-2xl flex items-center justify-center border-4 shadow-lg transition-all duration-500 ${
                              step.cancelled
                                ...
                                : step.active
                                ? "bg-gradient-to-r from-blue-500 to-purple-500 border-blue-500 shadow-blue-200 animate-pulse"
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200/50 p-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">
                Order <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Details</span>
              </h2>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">{order.mobileNumber}</p>
                  ...
                  <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-xl">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">{order.streetAddress}</p>
                ...
                <div className="space-y-4">
                  ...
                  {/* Total Amount */}
                  <div className="bg-gradient-to-r from-blue-500 to-purple-500 rounded-xl p-6 text-center mt-4">
                    <p className="text-white/80 text-sm font-medium mb-1">Total Amount</p>
                    <p className="text-3xl font-bold text-white">TK {order.total}</p>
                  </div>
                </div>
              </div>
            </div>
