    ...
    <div className="min-h-screen fixed inset-0 z-50 flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="flex flex-col items-center space-y-6 p-8 bg-white rounded-2xl shadow-lg border border-gray-100">
        ...
        <div className="relative">
          <div className="absolute inset-0 bg-indigo-400 rounded-full blur-md opacity-20 animate-ping"></div>
          <ShoppingBag className="w-16 h-16 text-indigo-400 relative z-10" />
        ...
        <div className="w-48 h-2 bg-gray-200 rounded-full overflow-hidden">
          <div className="h-full bg-gradient-to-r from-indigo-400 to-blue-500 rounded-full animate-progress"></div>
        </div>
        ...
        <div className="flex space-x-3">
          {[0, 1, 2].map((index) => (
            <div
              key={index}
              className="w-4 h-4 bg-gradient-to-br from-indigo-400 to-blue-600 rounded-full animate-rotate-scale"
